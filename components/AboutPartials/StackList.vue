            ...
            <v-row>
                <v-col cols="auto">
                    <v-list>
                        ...
                        <v-list-item
                            ...
                            :subtitle="
                                $t(
                                    'pages.about.table_headers.additional_framework'
                                )
                            "
                        >
                            <template #prepend>
                        ...
                        <v-list-item
                            ...
                            :subtitle="
                                $t(
                                    'pages.about.dev_prod.table_headers.message_brocker'
                                )
                            "
                        >
                            <template #prepend>
                                <v-icon color="orange"> mdi-rabbit </v-icon>
                            </template>
                        </v-list-item>
                        <v-list-item
                            title="Redis"
                            :subtitle="
                                $t(
                                    'pages.about.dev_prod.table_headers.cache_db'
                                )
                            "
                        >
                            <template #prepend>
                        ...
                        <v-list-item
                            ...
                            :subtitle="
                                $t(
                                    'pages.about.dev_prod.table_headers.version_control'
                                )
                            "
                        >
                            <template #prepend>
                        ...
                        <v-list-item
                            ...
                            :subtitle="
                                $t(
                                    'pages.about.dev_prod.table_headers.containerisation'
                                )
                            "
                        >
                            <template #prepend>
                ...
                <v-col>
                    ...
                    >
                        <v-spacer />
                        <v-avatar size="100">
                            <v-img src="/public/img/nuxt-logo.jpg" />
                        </v-avatar>
                        <v-spacer />
                        <v-avatar size="100">
                            <v-img src="/public/img/symfony-logo.png" />
                        </v-avatar>
                        <v-spacer />
                        <v-avatar size="100">
                            <v-img src="/public/img/docker-logo.png" />
                        </v-avatar>
                        <v-spacer />
                    </div>
                </v-col>
