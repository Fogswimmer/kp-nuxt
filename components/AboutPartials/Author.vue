	...
	>
		...
		<v-card-text>
			<v-card class="text-center" variant="text">
				...
				<v-card-text>
					<v-avatar size="200">
						<v-img src="/public/img/nebelschwimmer_avatar.jpg" />
					</v-avatar>
				</v-card-text>
				<v-spacer />
				<v-card-actions>
			...
			<v-list density="compact">
				...
				<v-list-item title="Node JS">
					<template #prepend>
						<v-icon color="green-darken-2"> mdi-nodejs </v-icon>
					</template>
				</v-list-item>
				...
				<v-list-item title="Kotlin">
					<template #prepend>
						<v-icon color="purple"> mdi-language-kotlin </v-icon>
					</template>
				</v-list-item>
				<v-divider />
				<v-list-subheader>
				...
				<v-list-item title="Android Development">
					<template #prepend>
